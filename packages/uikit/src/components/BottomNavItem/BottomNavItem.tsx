...
const BottomNavItem: React.FC<React.PropsWithChildren<BottomNavItemProps>> = ({
  ...
  const link = href === "/docs" ? "https://docs.mememayhem.io/" : (href === "/ifo" ? "https://www.pinksale.finance/launchpad/0xfF99F5d8d6a723907AC4d8c4bec298573b848c24?chain=Arbitrum" : href);
