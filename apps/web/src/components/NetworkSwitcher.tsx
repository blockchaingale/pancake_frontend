...
const WrongNetworkSelect = ({ switchNetwork, chainId }) => {
  ...
  const localChainId = useLocalNetworkChain() || ChainId.ARBITRUM
...
export const NetworkSwitcher = () => {
  ...
  console.log('chainId_NetworkSwitcher', chainId, 'isNotMatched', isNotMatched, 'isWrongNetwork', isWrongNetwork)
  ...
  return (
    <Box ref={cannotChangeNetwork ? targetRef : null} height="100%">
      ...
      <UserMenu
        ...
        avatarSrc="/images/chains/42161-1.png"
