      ...
      case 1:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'When the presale is live, you can “commit” your SMR to buy the MM tokens being sold.',
              )}
            </Text>
          </CardBody>
        )
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the Presale finish, you can claim MM that you bought, and any unspent SMR will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
