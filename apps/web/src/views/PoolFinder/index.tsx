          ...
          >
            {currency0 ? (
              <Row>
                ...
                <Text color='#212529' ml="8px">{currency0.symbol}</Text>
              </Row>
            ) : (
              <Text color='#212529' ml="8px">{t('Select a Token')}</Text>
            )}
          </StyledButton>
          ...
          >
            {currency1 ? (
              <Row>
                ...
                <Text color='#212529' ml="8px">{currency1.symbol}</Text>
              </Row>
            ) : (
              <Text color='#212529' as={Row}>{t('Select a Token')}</Text>
            )}
          </StyledButton>
