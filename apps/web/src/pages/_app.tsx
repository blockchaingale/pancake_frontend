  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="The most popular AMM on BSC! Earn MM through yield farming, then stake it in Pools to earn more tokens!"
        />
        ...
        <meta name="twitter:image" content="https://mememayhem.io/logo.png" />
      </Head>
      <DefaultSeo {...SEO} />
...
const App = ({ Component, pageProps }: AppPropsWithLayout) => {
  ...
  console.log('Component Chains', Component.chains)
  return (
    <Router>
